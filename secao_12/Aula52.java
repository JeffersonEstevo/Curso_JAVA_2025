...
Em Java, os operadores são divididos em vários grupos:
    ...
    • Operadores de Atrbuição: Atribuem valores a variáveis.
    • Operadores de Incremento e Decremento: Manipulação curtas de valores.

OPERADORES ARITMÉTICOS

Os operadores aritméticos são usados para relaizar operações matemáticas comuns:
    • Adição (+)
    • Subtração (-)
    • Multiplicação (*)
    • Divisão (/)
